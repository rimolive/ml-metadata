...
#ifndef GOOGLE_PROTOBUF_INCLUDED_zetasql_2fresolved_5fast_2fresolved_5fnode_5fkind_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_zetasql_2fresolved_5fast_2fresolved_5fnode_5fkind_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_zetasql_2fresolved_5fast_2fresolved_5fnode_5fkind_2eproto
...
struct TableStruct_zetasql_2fresolved_5fast_2fresolved_5fnode_5fkind_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_zetasql_2fresolved_5fast_2fresolved_5fnode_5fkind_2eproto;
PROTOBUF_NAMESPACE_OPEN
PROTOBUF_NAMESPACE_CLOSE
namespace zetasql {
...
constexpr ResolvedNodeKind ResolvedNodeKind_MAX = RESOLVED_ALTER_MODEL_STMT;
...
template<typename T>
inline const std::string& ResolvedNodeKind_Name(T enum_t_value) {
  static_assert(::std::is_same<T, ResolvedNodeKind>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function ResolvedNodeKind_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    ResolvedNodeKind_descriptor(), enum_t_value);
}
inline bool ResolvedNodeKind_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, ResolvedNodeKind* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<ResolvedNodeKind>(
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_zetasql_2fresolved_5fast_2fresolved_5fnode_5fkind_2eproto
