...
#ifndef GOOGLE_PROTOBUF_INCLUDED_zetasql_2fpublic_2fbuiltin_5ffunction_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_zetasql_2fpublic_2fbuiltin_5ffunction_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_zetasql_2fpublic_2fbuiltin_5ffunction_2eproto
...
struct TableStruct_zetasql_2fpublic_2fbuiltin_5ffunction_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_zetasql_2fpublic_2fbuiltin_5ffunction_2eproto;
PROTOBUF_NAMESPACE_OPEN
PROTOBUF_NAMESPACE_CLOSE
namespace zetasql {

enum FunctionSignatureId : int {
...
constexpr FunctionSignatureId FunctionSignatureId_MIN = __FunctionSignatureId__switch_must_have_a_default__;
constexpr FunctionSignatureId FunctionSignatureId_MAX = FN_D3A_COUNT_TO_HLL;
constexpr int FunctionSignatureId_ARRAYSIZE = FunctionSignatureId_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* FunctionSignatureId_descriptor();
template<typename T>
inline const std::string& FunctionSignatureId_Name(T enum_t_value) {
  static_assert(::std::is_same<T, FunctionSignatureId>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function FunctionSignatureId_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    FunctionSignatureId_descriptor(), enum_t_value);
}
inline bool FunctionSignatureId_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, FunctionSignatureId* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<FunctionSignatureId>(
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_zetasql_2fpublic_2fbuiltin_5ffunction_2eproto
