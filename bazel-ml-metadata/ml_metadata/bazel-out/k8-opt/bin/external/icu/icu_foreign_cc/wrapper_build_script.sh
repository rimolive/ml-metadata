...
export BUILD_WRAPPER_SCRIPT="bazel-out/k8-opt/bin/external/icu/icu_foreign_cc/wrapper_build_script.sh"
export BUILD_SCRIPT="bazel-out/k8-opt/bin/external/icu/icu_foreign_cc/build_script.sh"
export BUILD_LOG="bazel-out/k8-opt/bin/external/icu/icu_foreign_cc/Configure.log"
touch $BUILD_LOG
