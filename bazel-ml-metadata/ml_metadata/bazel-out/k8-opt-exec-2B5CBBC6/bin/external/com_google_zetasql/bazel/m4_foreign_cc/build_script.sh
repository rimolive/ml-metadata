...
export INSTALLDIR=$EXT_BUILD_ROOT/bazel-out/k8-opt-exec-2B5CBBC6/bin/external/com_google_zetasql/bazel/m4
...
mkdir -p $EXT_BUILD_ROOT/bazel-out/k8-opt-exec-2B5CBBC6/bin/external/com_google_zetasql/bazel/copy_m4/m4
cp -L -r --no-target-directory "$INSTALLDIR" "$EXT_BUILD_ROOT/bazel-out/k8-opt-exec-2B5CBBC6/bin/external/com_google_zetasql/bazel/copy_m4/m4" && find "$EXT_BUILD_ROOT/bazel-out/k8-opt-exec-2B5CBBC6/bin/external/com_google_zetasql/bazel/copy_m4/m4" -type f -exec touch -r "$INSTALLDIR" "{}" \;
cd $EXT_BUILD_ROOT
if [[ -L "bazel-out/k8-opt-exec-2B5CBBC6/bin/external/com_google_zetasql/bazel/m4/bin/m4" ]]; then
  target="$(readlink -f "bazel-out/k8-opt-exec-2B5CBBC6/bin/external/com_google_zetasql/bazel/m4/bin/m4")"
  rm "bazel-out/k8-opt-exec-2B5CBBC6/bin/external/com_google_zetasql/bazel/m4/bin/m4" && cp -a "${target}" "bazel-out/k8-opt-exec-2B5CBBC6/bin/external/com_google_zetasql/bazel/m4/bin/m4"
fi
