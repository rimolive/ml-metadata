...
export BUILD_WRAPPER_SCRIPT="bazel-out/host/bin/external/com_google_zetasql/bazel/bison_foreign_cc/wrapper_build_script.sh"
export BUILD_SCRIPT="bazel-out/host/bin/external/com_google_zetasql/bazel/bison_foreign_cc/build_script.sh"
export BUILD_LOG="bazel-out/host/bin/external/com_google_zetasql/bazel/bison_foreign_cc/Configure.log"
touch $BUILD_LOG
