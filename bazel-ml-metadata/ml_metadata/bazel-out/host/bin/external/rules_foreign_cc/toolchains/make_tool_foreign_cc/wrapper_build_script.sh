...
export BUILD_WRAPPER_SCRIPT="bazel-out/host/bin/external/rules_foreign_cc/toolchains/make_tool_foreign_cc/wrapper_build_script.sh"
export BUILD_SCRIPT="bazel-out/host/bin/external/rules_foreign_cc/toolchains/make_tool_foreign_cc/build_script.sh"
export BUILD_LOG="bazel-out/host/bin/external/rules_foreign_cc/toolchains/make_tool_foreign_cc/BootstrapGNUMake.log"
touch $BUILD_LOG
